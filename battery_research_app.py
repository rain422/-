...
<div style="display:flex;gap:0;margin-top:32px;border:1px solid #E2E8F0;border-radius:8px;overflow:hidden;"><div style="flex:1;background:#fff;border:1px solid #E2E8F0;border-radius:0;padding:36px 16px 28px;text-align:center;transition:all 0.2s;position:relative;" onmouseover="this.style.borderColor='#00B4A0';this.style.boxShadow='0 4px 16px rgba(0,180,160,0.1)'" onmouseout="this.style.borderColor='#E2E8F0';this.style.boxShadow='none'"><div style="margin:0 auto 16px;width:72px;height:72px;"><svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="36" cy="36" r="36" fill="#E6F7F5"/><polyline points="12,40 20,40 24,24 28,52 32,36 36,36 40,28 44,44 48,36 60,36" stroke="#00B4A0" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" fill="none"/></svg></div><div style="font-size:0.85rem;font-weight:700;color:#0D1B2A;margin-bottom:6px;">센서 데이터 수집</div><div style="font-size:0.74rem;color:#9EA5AF;line-height:1.55;">전압·전류·온도를 고정밀 센서로 실시간 수집합니다.</div></div><div style="display:flex;align-items:center;justify-content:center;width:32px;flex-shrink:0;background:#F7F8FA;border-top:1px solid #E2E8F0;border-bottom:1px solid #E2E8F0;"><span style="color:#00B4A0;font-size:1.2rem;font-weight:700;">›</span></div><div style="flex:1;background:#fff;border:1px solid #E2E8F0;border-radius:0;padding:36px 16px 28px;text-align:center;transition:all 0.2s;position:relative;" onmouseover="this.style.borderColor='#00B4A0';this.style.boxShadow='0 4px 16px rgba(0,180,160,0.1)'" onmouseout="this.style.borderColor='#E2E8F0';this.style.boxShadow='none'"><div style="margin:0 auto 16px;width:72px;height:72px;"><svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="36" cy="36" r="36" fill="#E6F7F5"/><line x1="12" y1="36" x2="22" y2="36" stroke="#00B4A0" stroke-width="2.5" stroke-linecap="round"/><rect x="22" y="29" width="10" height="14" rx="2" stroke="#00B4A0" stroke-width="2.5"/><line x1="32" y1="36" x2="40" y2="36" stroke="#00B4A0" stroke-width="2.5" stroke-linecap="round"/><rect x="40" y="29" width="10" height="14" rx="2" stroke="#00B4A0" stroke-width="2.5"/><line x1="50" y1="36" x2="60" y2="36" stroke="#00B4A0" stroke-width="2.5" stroke-linecap="round"/><line x1="36" y1="18" x2="36" y2="24" stroke="#0D9488" stroke-width="2" stroke-linecap="round"/><circle cx="36" cy="24" r="2.5" fill="#0D9488"/></svg></div><div style="font-size:0.85rem;font-weight:700;color:#0D1B2A;margin-bottom:6px;">등가 회로 모델링</div><div style="font-size:0.74rem;color:#9EA5AF;line-height:1.55;">배터리를 R₀·R₁C₁·OCV 등가 회로로 모델링합니다.</div></div><div style="display:flex;align-items:center;justify-content:center;width:32px;flex-shrink:0;background:#F7F8FA;border-top:1px solid #E2E8F0;border-bottom:1px solid #E2E8F0;"><span style="color:#00B4A0;font-size:1.2rem;font-weight:700;">›</span></div><div style="flex:1;background:#fff;border:1px solid #E2E8F0;border-radius:0;padding:36px 16px 28px;text-align:center;transition:all 0.2s;position:relative;" onmouseover="this.style.borderColor='#00B4A0';this.style.boxShadow='0 4px 16px rgba(0,180,160,0.1)'" onmouseout="this.style.borderColor='#E2E8F0';this.style.boxShadow='none'"><div style="margin:0 auto 16px;width:72px;height:72px;"><svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="36" cy="36" r="36" fill="#E6F7F5"/><line x1="15" y1="54" x2="57" y2="54" stroke="#00B4A0" stroke-width="2" stroke-linecap="round"/><line x1="15" y1="54" x2="15" y2="16" stroke="#00B4A0" stroke-width="2" stroke-linecap="round"/><line x1="18" y1="50" x2="54" y2="20" stroke="#0D9488" stroke-width="2" stroke-linecap="round" stroke-dasharray="3 2"/><circle cx="22" cy="46" r="3" fill="#00B4A0"/><circle cx="30" cy="40" r="3" fill="#00B4A0"/><circle cx="38" cy="32" r="3" fill="#00B4A0"/><circle cx="48" cy="25" r="3" fill="#00B4A0"/></svg></div><div style="font-size:0.85rem;font-weight:700;color:#0D1B2A;margin-bottom:6px;">파라미터 식별</div><div style="font-size:0.74rem;color:#9EA5AF;line-height:1.55;">OLS·WLS·TLS 최소제곱법으로 모델 파라미터를 추정합니다.</div></div><div style="display:flex;align-items:center;justify-content:center;width:32px;flex-shrink:0;background:#F7F8FA;border-top:1px solid #E2E8F0;border-bottom:1px solid #E2E8F0;"><span style="color:#00B4A0;font-size:1.2rem;font-weight:700;">›</span></div><div style="flex:1;background:#fff;border:1px solid #E2E8F0;border-radius:0;padding:36px 16px 28px;text-align:center;transition:all 0.2s;position:relative;" onmouseover="this.style.borderColor='#00B4A0';this.style.boxShadow='0 4px 16px rgba(0,180,160,0.1)'" onmouseout="this.style.borderColor='#E2E8F0';this.style.boxShadow='none'"><div style="margin:0 auto 16px;width:72px;height:72px;"><svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="36" cy="36" r="36" fill="#E6F7F5"/><polygon points="14,18 58,18 42,36 42,54 30,54 30,36" stroke="#00B4A0" stroke-width="2.5" stroke-linejoin="round" fill="#C7F0EB"/><line x1="14" y1="18" x2="58" y2="18" stroke="#00B4A0" stroke-width="2.5" stroke-linecap="round"/></svg></div><div style="font-size:0.85rem;font-weight:700;color:#0D1B2A;margin-bottom:6px;">상태 추정 (필터)</div><div style="font-size:0.74rem;color:#9EA5AF;line-height:1.55;">EKF·SPKF 칼만 필터로 SOC·SOH를 실시간 추정합니다.</div></div><div style="display:flex;align-items:center;justify-content:center;width:32px;flex-shrink:0;background:#F7F8FA;border-top:1px solid #E2E8F0;border-bottom:1px solid #E2E8F0;"><span style="color:#00B4A0;font-size:1.2rem;font-weight:700;">›</span></div><div style="flex:1;background:#fff;border:1px solid #E2E8F0;border-radius:0;padding:36px 16px 28px;text-align:center;transition:all 0.2s;position:relative;" onmouseover="this.style.borderColor='#00B4A0';this.style.boxShadow='0 4px 16px rgba(0,180,160,0.1)'" onmouseout="this.style.borderColor='#E2E8F0';this.style.boxShadow='none'"><div style="margin:0 auto 16px;width:72px;height:72px;"><svg width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="36" cy="36" r="36" fill="#E6F7F5"/><circle cx="36" cy="36" r="16" stroke="#00B4A0" stroke-width="2.5"/><polyline points="27,36 33,42 45,30" stroke="#00B4A0" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg></div><div style="font-size:0.85rem;font-weight:700;color:#0D1B2A;margin-bottom:6px;">검증 및 보정</div><div style="font-size:0.74rem;color:#9EA5AF;line-height:1.55;">RMSE·MAE로 정확도를 평가하고 모델을 지속 업데이트합니다.</div></div></div>
<div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:24px;"><div style="background:#fff;border:1px solid #E2E8F0;border-radius:8px;border-top:3px solid #00B4A0;padding:22px 24px;"><div style="font-size:0.9rem;font-weight:700;color:#0D1B2A;margin-bottom:5px;">등가 회로 모델 (ECM)</div><div style="font-size:0.78rem;color:#6B7280;margin-bottom:12px;">배터리를 전기 회로로 단순화하여 실시간 BMS 계산을 가능하게 합니다.</div><div style="font-size:0.76rem;color:#334155;padding:7px 0;border-bottom:1px solid #EEF0F3;font-family:monospace;letter-spacing:-0.2px;">▸ R₀ : 순수 내부 저항 — 즉각 전압 강하</div><div style="font-size:0.76rem;color:#334155;padding:7px 0;border-bottom:1px solid #EEF0F3;font-family:monospace;letter-spacing:-0.2px;">▸ R₁C₁ : 전기화학 분극 — 시정수 τ = R₁C₁</div><div style="font-size:0.76rem;color:#334155;padding:7px 0;border-bottom:1px solid #EEF0F3;font-family:monospace;letter-spacing:-0.2px;">▸ OCV : 개방 회로 전압 — SOC의 비선형 함수</div><div style="font-size:0.76rem;color:#334155;padding:7px 0;border-bottom:1px solid #EEF0F3;font-family:monospace;letter-spacing:-0.2px;">▸ V = OCV - I·R₀ - V_RC</div></div><div style="background:#fff;border:1px solid #E2E8F0;border-radius:8px;border-top:3px solid #00B4A0;padding:22px 24px;"><div style="font-size:0.9rem;font-weight:700;color:#0D1B2A;margin-bottom:5px;">칼만 필터 추정 공정</div><div style="font-size:0.78rem;color:#6B7280;margin-bottom:12px;">예측(Predict)과 업데이트(Update) 두 단계를 반복하여 최적 추정합니다.</div><div style="font-size:0.76rem;color:#334155;padding:7px 0;border-bottom:1px solid #EEF0F3;font-family:monospace;letter-spacing:-0.2px;">▸ 예측: x̂⁻ = f(x̂, u) — 상태 전파</div><div style="font-size:0.76rem;color:#334155;padding:7px 0;border-bottom:1px solid #EEF0F3;font-family:monospace;letter-spacing:-0.2px;">▸ 예측: P⁻ = F·P·Fᵀ + Q — 오차 공분산</div><div style="font-size:0.76rem;color:#334155;padding:7px 0;border-bottom:1px solid #EEF0F3;font-family:monospace;letter-spacing:-0.2px;">▸ 업데이트: K = P⁻Hᵀ(HP⁻Hᵀ+R)⁻¹ — 칼만 이득</div><div style="font-size:0.76rem;color:#334155;padding:7px 0;border-bottom:1px solid #EEF0F3;font-family:monospace;letter-spacing:-0.2px;">▸ 업데이트: x̂ = x̂⁻ + K(y - h(x̂⁻)) — 상태 보정</div></div></div>
</div>
